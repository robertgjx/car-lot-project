...
const SPOTLIGHT_ID = "2010-ford-ranger-???";
  ...
  return (
    <aside className="hidden xl:flex flex-col w-[260px] shrink-0">
      <style>{`
        ...
        .sp-spin {
          ...
          background: conic-gradient(
            #dc2626 0deg,   #dc2626 45deg,
            #fbbf24 45deg,  #fbbf24 90deg,
            #dc2626 90deg,  #dc2626 135deg,
            #fbbf24 135deg, #fbbf24 180deg,
            #dc2626 180deg, #dc2626 225deg,
            #fbbf24 225deg, #fbbf24 270deg,
            #dc2626 270deg, #dc2626 315deg,
            #fbbf24 315deg, #fbbf24 360deg
          );
          animation: spinStripes 1.5s linear infinite;
        }
        .sp-flash {
      ...
      <div className="sticky top-8">
        ...
        <div className="sp-flash relative rounded-[22px] p-[5px] overflow-hidden">
          <div className="sp-spin" />

          {/* White card */}
          <div className="relative z-10 rounded-[17px] bg-white overflow-hidden">
